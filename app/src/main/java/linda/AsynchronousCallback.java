 ...
 * The callback fires asynchronously with other threads and may do whatever it
 * wants (it may block).
 * 
...
public class AsynchronousCallback implements Callback {
    ...
    public AsynchronousCallback(Callback cb) {
        this.cb = cb;
    }

    /**
     * Asynchronous call: the associated callback is concurrently run and this one
     * immediately returns.
     */
