...
public class Tuple extends LinkedList<Serializable> implements Serializable {
     ...
     * new Tuple(4, Integer.class, "foo".getclass(), Boolean.class) -> [ 4 ?Integer
     * ?String ?Boolean ]
     */
     ...
     * an instance/implementation of this class/interface (Class.isInstance);
     * - if the template component is a class/interface, and the tuple component is
     * a subclass/subinterface of this class/interface (Class.isAsssignableFrom);
     * - recursively if both are tuples.
     *
     * Examples:
     * [ 3 5 "foo" ] matches [ 3 5 "foo" ], [ ?Integer 5 "foo" ], [ ?Integer
     * ?Integer ?String ]
     * [ 3 ?Integer [ 6 7 ] [ 7 8 ] ] matches [ ?Integer ?Integer [ ?Integer 7 ]
     * ?Tuple ], [3 ?Integer ?Tuple ?Tuple ]
     *
     ...
     */
    /*
     * Les éléments types sont représentés par des instances de Class, qui n'est pas
     * cloneable.
     * Le plus simple de passer par une sérialisation/desérialisation ce qui marche
     * pour toutes les classes qui implantent serializable.
     */
     ...
     * Known values: integer (45, -67), boolean (true, false), string ("toto"),
     * classname (?Integer, ?java.awt.Rectangle), recursive tuple.
     * Examples: [ 3 4 ], [ ?Integer "toto" true 78 ?Boolean ], [ ?Integer ?Tuple ],
     * [ [ true 78 ] [ 3 4 [ 5 6 ] 7 ] ]
     * For these components, the parsable strings are identical to the printed
     * strings.
